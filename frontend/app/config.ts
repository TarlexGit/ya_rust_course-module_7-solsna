...
export const ORACLE_PROGRAM_ID = "7SjPCZFdcXPe2Z79eCJX2VtCrKLoqdhHYcYxaNxEjM9f";
export const MINTER_PROGRAM_ID = "7twiuwVZXbPuHtLJWXvHDZuiAuH9zyVwKmkMDV3gC56K";
