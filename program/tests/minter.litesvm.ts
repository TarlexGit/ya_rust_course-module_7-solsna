...
const ORACLE_PROGRAM_ID = new PublicKey("7SjPCZFdcXPe2Z79eCJX2VtCrKLoqdhHYcYxaNxEjM9f");
const MINTER_PROGRAM_ID = new PublicKey("7twiuwVZXbPuHtLJWXvHDZuiAuH9zyVwKmkMDV3gC56K");
